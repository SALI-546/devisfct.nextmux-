                    ...
                    {[1, 2, 3].map((card) => (
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {card === 1 ? 'En cours' : card === 2 ? 'Validé' : 'Brouillon'}
                                </div>
                                <h3 className="text-xl font-semibold text-gray-800 mb-2">Devis #{2024 + card}</h3>
                                <div className="flex items-center text-sm text-gray-500">
                                    <span>Client: Entreprise {card}</span>
                                    <span className="mx-2">•</span>
                                    <span>{card === 1 ? '3 500 €' : card === 2 ? '2 800 €' : '1 200 €'}</span>
                                </div>
                                <div className="mt-4 text-sm text-gray-500">
                                    {card === 1
                                        ? 'Créé le 15-03-2024'
                                        : card === 2
                                            ? 'Validé le 14-03-2024'
