...
const ConditionsForm = ({ formData, handleInputChange, handleSignatureChange }) => {
    ...
    const statusOptions = ["Payé", "Impayé", "En cours"];
    ...
    return (
        <div className="space-y-4 mb-16">
            ...
            <div>
                ...
                <CustomPaymentSelect
                    value={formData.conditions.statut}
                    onChange={(value) =>
                        handleInputChange("conditions", {
                            ...formData.conditions,
                            statut: value,
            ...
            <div>
                ...
                <div className="border-2 border-dashed rounded-lg p-4 text-center relative bg-gray-50">
                    <input
                        type="file"
                        accept="image/*"
                    ...
                    {formData.conditions.signature ? (
                        ...
                        <p className="text-sm text-gray-500">Glissez-déposez ou cliquez pour télécharger la signature numérique.</p>
                    )}
                </div>
            </div>
        </div>
